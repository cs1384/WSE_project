...
import wseproject.TableAnalyzer.MonotonicLog;
import wseproject.TableAnalyzer.RowProps;
...
public class TableParser 
{
            ...
            for(int i=1;i<rowsX.size();i++)   
            {
                ...
                for(int j=1;j<cols.length;j++)
                {
                    ...
                    for(int p=0;p<rowspanList.size();p++)
                    {
                        ...
                        if(j-1 == rsl.afterWhich && i == rsl.row)
                        {
                        ...
                        if(i == rsl.row && j == 1 && rsl.afterWhich == -1 )
                        {
                            foundAt = 0;
                            break;
                        }
                    ...
                    if(foundAt != -1)
                    {
                        ...
                        for(int ii=0;ii<rsl.howMany;ii++)
                        {
                            if(rsl.afterWhich == -1)
                            {
                                //rowCols.add();
                                rowCols.insertElementAt(cleanupCell(rsl.contents), rowCols.size()-1);
                            }
                            else
                                rowCols.add(cleanupCell(rsl.contents));
                        }
    ...
    */
    ...
    class ColRowSpanException extends Exception
    {
